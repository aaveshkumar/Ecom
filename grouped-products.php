                ...
                <div class="col-xl-12">
                    <div class="product-area details-product-area mb--70 justify-content-center">
                        <div class="product-thumb-area">
                            ...
                            <div class="thumb-wrapper one filterd-items figure">
                                <div class="product-thumb zoom" onmousemove="zoom(event)"
                                    style="background-image: url(assets/images/hand-picked/slider-img8_3.jpg)"><img
                                        src="assets/images/hand-picked/slider-img8_3.jpg" alt="product-thumb">
                                </div>
                            </div>
                            ...
                            <div class="product-thumb-filter-group">
                                <div class="thumb-filter filter-btn active" data-show=".one"><img
                                        src="assets/images/hand-picked/slider-img8_3.jpg" alt="product-thumb-filter"></div>
                                <div class="thumb-filter filter-btn" data-show=".two"><img
                                        src="assets/images/hand-picked/woman-shirt-338x450.png" alt="product-thumb-filter"></div>
                        ...
                        <div class="contents">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text">
                                                <a href="product-details.php">Women's Blouse</a>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text">
                                                <a href="product-details.php">Women's Tshirt</a>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="price-text">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text">
                                                <a href="product-details.php">Girl's Top</a>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="price-text">
                            ...
                            <div class="product-bottom-action4">
                                <div class="button">
                                    <button class="form-btn1 form-btn4">
