            ...
            <div class="details-product-area mb--70">
                ...
                <div class="contents">
                    ...
                    <div class="product-bottom-action">
                        ...
                        <a href="cart.php" class="addto-cart-btn action-item"><i class="rt-basket-shopping"></i> Add To
                            Cart</a>
                            ...
                            <div class="col-lg-12 col-md-12 mr-10">
                                <div class="reveiw-form">
                                    <h2 class="section-title">
                                        Be the first to reveiw <strong> <a href="product-details.php">"Wide Cotton Tunic Dress"</a></strong></h2>
