...
<html lang="en" class="darkmode" data-theme="light">
   ...
   <?php $css = '<link rel="stylesheet" href="assets/css/variables/variable4.css">';?>
            ...
            <div class="navbar-part navbar-part3 navbar-part4">
                <div class="container">
                    <div class="navbar-inner navbar-inner5">
                        ...
                        <a href="index.php" class="logo"><img src="assets/images/logo2.png" alt="weiboo-logo"></a>
                        ...
                        <div class="header-action-items header-action-items1">
                            ...
                            <div class="wishlist action-item">
                                <div class="favourite-icon icon"><a href="wishlist.php"><i class="rt-heart"></i></a>
                                </div>
                            </div>
            ...
            <div class="navbar-part navbar-part2 lower-navbar lower-navbar4">
                <div class="container">
                    <div class="navbar-inner">
                        <a href="index.php" class="logo"><img src="assets/images/logo4.svg" alt="umart-logo"></a>
                        <div class="navbar-coupon-code">
                            <div class="icon"><img src="assets/images/icons/percent-tag.png" alt="tag-icon"></div>
                            <div class="content">
                    ...
                    <div class="col-xl-2 col-md-4 col-sm-12 gutter-1">
                        <div class="catagory-sidebar">
                            <div class="widget-bg">
                                ...
                                <nav>
                                    <ul>
                                        <li><a href="shop.php">Action <i class="rt rt-arrow-right-long"></i></a></li>
                                        <li><a href="shop.php">Adventure <i class="rt rt-arrow-right-long"></i></a></li>
                                        <li><a href="shop.php">Ghost Story <i class="rt rt-arrow-right-long"></i></a></li>
                                        <li><a href="shop.php">Racing <i class="rt rt-arrow-right-long"></i></a></li>
                                        <li><a href="shop.php">Cell Phones <i class="rt rt-arrow-right-long"></i></a></li>
                                        <li><a href="shop.php">Electronics <i class="rt rt-arrow-right-long"></i></a></li>
                                        <li><a href="shop.php">Gaming <i class="rt rt-arrow-right-long"></i></a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
            ...
            <div class="section-inner">
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="product-item7">
                            <div class="product-image">
                                <img src="assets/images/products/home8/game01.webp" alt="">
                            </div>
                            <div class="bottom-text">
                                <a href="shop.php" class="sub-title">New Collections</a>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="product-item7">
                            <div class="product-image">
                                <img src="assets/images/products/home8/fifa.webp" alt="">
                            </div>
                            <div class="bottom-text">
                                <a href="shop.php" class="sub-title">New Collections</a>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="product-item7">
                            <div class="product-image">
                                <img src="assets/images/products/home8/samuri.webp" alt="">
                            </div>
                            <div class="bottom-text">
                                <a href="shop.php" class="sub-title">New Collections</a>
            ...
            <div class="rts-featured-product-section-inner">
                <div class="section-header section-header3">
                    <div class="wrapper">
                        ...
                        <a href="shop.php" class="section-button">Veiw All</a>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/products/home8/gun-410x410.webp" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Online Action Game</a>
                                <div class="action-wrap">
                                    <span class="price">$39.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add to Cart</a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/products/home8/action-410x410.webp" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Life Of Gun</a>
                                <div class="action-wrap">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/products/home8/racing-410x410.webp" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Speed Racing Game</a>
                                <div class="action-wrap">
                                    <span class="price">$220.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add to Cart</a>
                                </div>
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/products/home8/Carmaker-410x410.webp" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Action With Jailer</a>
                                <div class="action-wrap">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/products/home8/game2-410x410.webp" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Legends Of Runeterra</a>
                                <div class="action-wrap">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/products/home8/gaming-410x410.webp" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Genchin Impact</a>
                                <div class="action-wrap">
                                    <span class="price">$220.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add to Cart</a>
                                </div>
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/products/home8/ghost-410x410.webp" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Royale Ghost Story</a>
                                <div class="action-wrap">
                                    <span class="price">$220.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add to Cart</a>
                                </div>
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/products/home8/cod-410x410.jpg" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Call Of Duty</a>
                                <div class="action-wrap">
                                    <span class="price">$220.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add to Cart</a>
                                </div>
                    ...
                    <div class="brands-section-inner">
                        <div class="slider-div">
                            <div class="swiper rts-brandSlide1">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a class="brand-front" href="#"><img src="assets/images/brands/panther4.webp"
                                                alt="Brand Logo"></a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a class="brand-front" href="#"><img src="assets/images/brands/231.webp"
                                                alt="Brand Logo"></a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a class="brand-front" href="#"><img src="assets/images/brands/531.webp"
                                                alt="Brand Logo"></a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a class="brand-front" href="#"><img src="assets/images/brands/5466967.webp"
                                                alt="Brand Logo"></a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a class="brand-front" href="#"><img src="assets/images/brands/5485618.webp"
                                                alt="Brand Logo"></a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a class="brand-front" href="#"><img src="assets/images/brands/5572905.webp"
                                                alt="Brand Logo"></a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <a href="shop.php" class="service-item">
                        <div class="service-icon"><img src="assets/images/products/home8/cat-action.jpg" alt="service-icon"></div>
                        <div class="contents">
                ...
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <a href="shop.php" class="service-item">
                        <div class="service-icon"><img src="assets/images/products/home8/game2.webp" alt="service-icon">
                        </div>
                        <div class="contents">
                ...
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <a href="shop.php" class="service-item">
                        <div class="service-icon"><img src="assets/images/products/home8/modern-cars.jpg" alt="service-icon">
                        </div>
                        <div class="contents">
                ...
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <a href="shop.php" class="service-item">
                        <div class="service-icon"><img src="assets/images/products/home8/120.jpg" alt="service-icon"></div>
                        <div class="contents">
                ...
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <a href="shop.php" class="service-item">
                        <div class="service-icon"><img src="assets/images/products/home8/samuri.webp" alt="service-icon"></div>
                        <div class="contents">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-md-6">
                    <div class="feed-item">
                        <a href="news-details.php" class="feed-image"><img src="assets/images/products/home8/modern-gamepads.webp"
                                alt="feed-image"></a>
                        <div class="contents">
                            <p class="date"> June 11, 2024 </p>
                            <h2 class="feed-title"><a href="news-details.php">Online Game Competition</a></h2>
                            <a href="news-details.php" class="content-button">Read More <i class="fa fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="feed-item">
                        <a href="news-details.php" class="feed-image"><img src="assets/images/products/home8/e-sport-arena.webp"
                                alt="feed-image"></a>
                        <div class="contents">
                            <p class="date"> June 7, 2024 </p>
                            <h2 class="feed-title"><a href="news-details.php">Pubg News 2023</a></h2>
                            <a href="news-details.php" class="content-button">Read More <i class="fa fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="feed-item last-child">
                        <a href="news-details.php" class="feed-image"><img src="assets/images/products/home8/202k-768x512.webp"
                                alt="feed-image"></a>
                        <div class="contents">
                            <p class="date"> June 3, 2024 </p>
                            <h2 class="feed-title"><a href="news-details.php">WWE 2k22 Review</a></h2>
                            <a href="news-details.php" class="content-button">Read More <i class="fa fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-sm-6 box-widget-col">
                        <div class="footer-widget footer-box-widget">
                            <div class="footer-logo"><img src="assets/images/logo2.png" alt="footer-logo"></div>
                            <p>Solid is the information & experience
                                directed at an end-user</p>
                            <div class="quick-contact">
                                <div class="phone contact-item">
                                    <div class="icon"><img src="assets/images/icons/24clock2.png" alt="chat-icon">
                                    </div>
                                ...
                                <div class="email contact-item">
                                    <div class="icon"><img src="assets/images/icons/mail2.png" alt="phone-icon">
                                    </div>
                                    <div class="contact-info">
