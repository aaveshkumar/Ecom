...
<?php $css = '<link rel="stylesheet" href="assets/css/variables/variable5.css">';?>
...
<body>
        ...
        <div class="header-topbar header-topbar2 header-topbar5">
            <div class="container header-container">
                <div class="header-top-inner">
                    <h3 class="welcome-text">35% Exclusive discount plus free next day delivery, <a href="shop.php"
            ...
            <div class="navbar-part navbar-part3 navbar-part5">
                <div class="container header-container">
                    <div class="navbar-inner navbar-inner2">
                        <a href="index.php" class="logo"><img src="assets/images/logo2.svg" alt="weiboo-logo"></a>
                            ...
                            <div class="container">
                                <div class="single-inner">
                                    ...
                                    <div class="banner-product-thumb"><img
                                            src="assets/images/products/banner-product5.png" alt="banner-product"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="rts-product-category-section section-gap">
        <div class="container">
            <div class="row">
                <div class="col-xl-2">
                    <a href="category.php" class="product-item product-item-vertical">
                        <div class="product-thumb"><img src="assets/images/products/home5/category/1.png"
                ...
                <div class="col-xl-8">
                    <div class="row">
                        <div class="col-xl-4 col-md-6 col-sm-6">
                            <a href="category.php" class="product-item product-item-horizontal">
                                <div class="product-thumb"><img src="assets/images/products/home5/category/2.png"
                                        alt="product-image"></div>
                                <div class="contents">
                                    <span class="item-qnty">10 Items</span>
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-6">
                            <a href="category.php" class="product-item product-item-horizontal">
                                <div class="product-thumb"><img src="assets/images/products/home5/category/3.png"
                                        alt="product-image"></div>
                                <div class="contents">
                                    <span class="item-qnty">10 Items</span>
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-6">
                            <a href="category.php" class="product-item product-item-horizontal">
                                <div class="product-thumb"><img src="assets/images/products/home5/category/4.png"
                                        alt="product-image"></div>
                                <div class="contents">
                                    <span class="item-qnty">10 Items</span>
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-6">
                            <a href="category.php" class="product-item product-item-horizontal">
                                <div class="product-thumb"><img src="assets/images/products/home5/category/5.png"
                                        alt="product-image"></div>
                                <div class="contents">
                                    <span class="item-qnty">10 Items</span>
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-6">
                            <a href="category.php" class="product-item product-item-horizontal">
                                <div class="product-thumb"><img src="assets/images/products/home5/category/6.png"
                                        alt="product-image"></div>
                                <div class="contents">
                                    <span class="item-qnty">10 Items</span>
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-6">
                            <a href="category.php" class="product-item product-item-horizontal">
                                <div class="product-thumb"><img src="assets/images/products/home5/category/7.png"
                                        alt="product-image"></div>
                                <div class="contents">
                                    <span class="item-qnty">10 Items</span>
                ...
                <div class="col-lg-2 col-md-12">
                    <a href="category.php" class="product-item product-item-vertical product-item-bg">
                        <div class="product-thumb"><img src="assets/images/products/home5/category/8.png"
                                alt="product-image"></div>
                        <div class="contents">
    ...
    <div class="rts-featured-product-section rts-featured-product-section2 section-gap">
        <div class="container">
            <div class="section-header section-header4">
                ...
                <a href="shop-main.php" class="go-btn">All Products <i class="fal fa-long-arrow-right"></i></a>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <div class="product-item">
                        ...
                        <a href="product-details.php" class="product-thumb"><img
                                src="assets/images/products/home5/1.png" alt="product-image"></a>
                        <div class="contents">
                            <span class="product-type">Cookie</span>
                            <a href="product-details.php" class="product-title">Sweet Onion Salsa</a>
                        ...
                        <div class="product-bottom-action">
                            <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-bag mr--5"></i> Add To
                                Cart</a>
                ...
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <div class="product-item">
                        ...
                        <a href="product-details.php" class="product-thumb"><img
                                src="assets/images/products/home5/2.png" alt="product-image"></a>
                        <div class="contents">
                            <span class="product-type">Cookie</span>
                            <a href="product-details.php" class="product-title">Chocolate Chips</a>
                            <div class="product-bottom-content">
                ...
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <div class="product-item">
                        ...
                        <a href="product-details.php" class="product-thumb"><img
                                src="assets/images/products/home5/3.png" alt="product-image"></a>
                        <div class="contents">
                            <span class="product-type">Cookie</span>
                            <a href="product-details.php" class="product-title">Meatless Chicken Tender</a>
                            <div class="product-bottom-content">
                                <span class="product-price">$230,00</span>
                                <button class="wishlist"><i class="rt-heart"></i></button>
                            </div>
                ...
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <div class="product-item">
                        ...
                        <a href="product-details.php" class="product-thumb"><img
                                src="assets/images/products/home5/4.png" alt="product-image"></a>
                        <div class="contents">
                            <span class="product-type">Cookie</span>
                            <a href="product-details.php" class="product-title">Cherry Spoiling Water</a>
                            <div class="product-bottom-content">
                                <span class="product-price">$230,00 <span class="old-price">$460,00</span></span>
                                <button class="wishlist"><i class="rt-heart"></i></button>
                            </div>
                ...
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <div class="product-item">
                        ...
                        <a href="product-details.php" class="product-thumb"><img
                                src="assets/images/products/home5/5.png" alt="product-image"></a>
                        <div class="contents">
                            <span class="product-type">Cookie</span>
                            <a href="product-details.php" class="product-title">Mixed Vegetables</a>
                            <div class="product-bottom-content">
                                <span class="product-price">$230,00</span>
                                <button class="wishlist"><i class="rt-heart"></i></button>
                            </div>
                ...
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <div class="product-item">
                        ...
                        <a href="product-details.php" class="product-thumb"><img
                                src="assets/images/products/home5/6.png" alt="product-image"></a>
                        <div class="contents">
                            <span class="product-type">Cookie</span>
                            <a href="product-details.php" class="product-title">Jerry Jam Bites</a>
                            <div class="product-bottom-content">
                                <span class="product-price">$230,00 <span class="old-price">$460,00</span></span>
                                <button class="wishlist"><i class="rt-heart"></i></button>
                            </div>
                ...
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <div class="product-item">
                        ...
                        <a href="product-details.php" class="product-thumb"><img
                                src="assets/images/products/home5/7.png" alt="product-image"></a>
                        <div class="contents">
                            <span class="product-type">Cookie</span>
                            <a href="product-details.php" class="product-title">Organic Broccoli Cuts</a>
                            <div class="product-bottom-content">
                                <span class="product-price">$230,00</span>
                                <button class="wishlist"><i class="rt-heart"></i></button>
                            </div>
                ...
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <div class="product-item">
                        ...
                        <a href="product-details.php" class="product-thumb"><img
                                src="assets/images/products/home5/8.png" alt="product-image"></a>
                        <div class="contents">
                            <span class="product-type">Cookie</span>
                            <a href="product-details.php" class="product-title">Mango Chunks</a>
                            <div class="product-bottom-content">
                                <span class="product-price">$230,00</span>
                                <button class="wishlist"><i class="rt-heart"></i></button>
                            </div>
                ...
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <div class="product-item">
                        ...
                        <a href="product-details.php" class="product-thumb"><img
                                src="assets/images/products/home5/9.png" alt="product-image"></a>
                        <div class="contents">
                            <span class="product-type">Cookie</span>
                            <a href="product-details.php" class="product-title">Turkey Burgers</a>
                            <div class="product-bottom-content">
                                <span class="product-price">$230,00 <span class="old-price">$460,00</span></span>
                                <button class="wishlist"><i class="rt-heart"></i></button>
                            </div>
                ...
                <div class="col-lg-15 col-md-4 col-sm-6">
                    <div class="product-item">
                        ...
                        <a href="product-details.php" class="product-thumb"><img
                                src="assets/images/products/home5/10.png" alt="product-image"></a>
                        <div class="contents">
                            <span class="product-type">Cookie</span>
                            <a href="product-details.php" class="product-title">Rising Cust Pizza</a>
                            <div class="product-bottom-content">
                                <span class="product-price">$230,00</span>
                                <button class="wishlist"><i class="rt-heart"></i></button>
                            </div>
            ...
            <div class="row">
                <div class="col-d-35 col-xl-6 col-lg-6 col-md-6">
                    <div class="product detail-product one filterd-items">
                        <a href="product-details.php" class="product-thumb"><img
                                src="assets/images/products/home5/7.png" alt="product-thumb"></a>
                        <div class="contents">
                            ...
                            <a href="product-details.php" class="product-title">Organic Broccoli Cuts <br>
                                Android 10.0 OS</a>
                ...
                <div class="col-d-35 col-xl-6 col-lg-6 col-md-6">
                    <div class="product detail-product one filterd-items">
                        <a href="product-details.php" class="product-thumb"><img
                                src="assets/images/products/home5/9.png" alt="product-thumb"></a>
                        <div class="contents">
                            <div class="rating-area">
                                <div class="rating-stars-group">
                                    <div class="rating-star"><i class="fas fa-star"></i></div>
                            ...
                            <a href="product-details.php" class="product-title">Turkey Burgers <br>
                                Android 10.0 OS</a>
                            <span class="product-price">$129.99 <span class="old-price">$349.99</span></span>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12 col-md-6">
                            <div class="product-item">
                                ...
                                <div class="contents">
                                    ...
                                    <a href="product-details.php" class="product-title">Chicok Butter with Canola Oil
                                        400ML</a>
                                    <span class="product-price">$230,00</span>
                                </div>
                            </div>
    ...
    <div class="rts-restriction-notice section-gap">
        <h3 class="notice"><a href="news-details.php" class="highlight"><span class="star">**</span>See offer
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6">
                        <div class="feature-item">
                            <div class="icon"><img src="assets/images/icons/footerft1.png" alt="icon"></div>
                            <div class="content">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="feature-item">
                            <div class="icon"><img src="assets/images/icons/footerft2.png" alt="icon"></div>
                            <div class="content">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="feature-item">
                            <div class="icon"><img src="assets/images/icons/footerft3.png" alt="icon"></div>
                            <div class="content">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="feature-item last-child">
                            <div class="icon"><img src="assets/images/icons/footerft4.png" alt="icon"></div>
                            <div class="content">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-sm-6 box-widget-col">
                        <div class="footer-widget footer-box-widget">
                            <div class="footer-logo"><img src="assets/images/logo2.svg" alt="footer-logo"></div>
                            <p>Solid is the information & experience
                                directed at an end-user</p>
                            <div class="quick-contact">
                                <div class="phone contact-item">
                                    <div class="icon"><img src="assets/images/icons/24clock3.png" alt="chat-icon">
                                    </div>
                                ...
                                <div class="email contact-item">
                                    <div class="icon"><img src="assets/images/icons/mail3.png" alt="phone-icon">
                                    </div>
                                    <div class="contact-info">
