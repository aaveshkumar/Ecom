...
<?php $css = '<link rel="stylesheet" href="assets/css/variables/variable3.css">';?>
            ...
            <div class="navbar-part navbar-part navbar-part3">
                <div class="container">
                    <div class="navbar-inner navbar-inner2">
                        <a href="index.php" class="logo"><img src="assets/images/logo7.svg" alt="umart-logo"></a>
            ...
            <div class="navbar-part navbar-part2 lower-navbar">
                <div class="container">
                    <div class="navbar-inner">
                        <a href="index.php" class="logo"><img src="assets/images/logo3.svg" alt="umart-logo"></a>
                                ...
                                <div class="single-inner">
                                    <div class="contents">
                                        ...
                                        <div class="banner-action">
                                            <a class="banner-btn banner-btn2" href="product-details.php"><i
            ...
            <div class="row">
                <div class="col-xl-3 col-md-6 col-sm-6">
                    <div class="catagory-box box1">
                        <a href="category.php" class="picture"><img src="assets/images/post/cata1.png"
                                alt="box-picture"></a>
                        <a href="category.php" class="view-collection-btn">View Collection</a>
                        <div class="contents">
                ...
                <div class="col-xl-3 col-md-6 col-sm-6">
                    <div class="catagory-box box2">
                        <a href="category.php" class="picture"><img src="assets/images/post/cata2.png"
                                alt="box-picture"></a>
                        <a href="category.php" class="view-collection-btn">View Collection</a>
                        <div class="contents">
                ...
                <div class="col-xl-3 col-md-6 col-sm-6">
                    <div class="catagory-box box3">
                        <a href="category.php" class="picture"><img src="assets/images/post/cata3.png"
                                alt="box-picture"></a>
                        <a href="category.php" class="view-collection-btn">View Collection</a>
                        <div class="contents">
                ...
                <div class="col-xl-3 col-md-6 col-sm-6">
                    <div class="catagory-box box4 last-child">
                        <a href="category.php" class="picture"><img src="assets/images/post/cata4.png"
                                alt="box-picture"></a>
                        <a href="category.php" class="view-collection-btn">View Collection</a>
                        <div class="contents">
    ...
    <div class="rts-recent_products-section section-gap">
        <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item product-item2 element-item2">
                            ...
                            <div class="bottom-content">
                                <span class="product-catagory">Hand Craft</span>
                                <a href="product-details.php" class="product-name">Wooden Handicraft</a>
                                <div class="action-wrap">
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item product-item2 element-item1">
                            ...
                            <div class="bottom-content">
                                <span class="product-catagory">Hand Craft</span>
                                <a href="product-details.php" class="product-name">Modern Handicraft</a>
                                <div class="action-wrap">
                                    <span class="product-price">$31.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                                        Cart</a>
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item product-item2 element-item1">
                            ...
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Modern Glasses Mug</a>
                                <div class="action-wrap">
                                    <span class="product-price">$31.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                                        Cart</a>
            ...
            <div class="d-flex justify-content-center">
                <a href="shop.php" class="all-products-link">All products <i
        ...
        <div class="container">
            ...
            <div class="slider-div">
                <div class="swiper rts-sixSlide-over">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="collection-item"><a class="collection-image" href="product-details.php"><img
                                        src="assets/images/products/home3/1.jpg" alt="collection-image"></a>
                                <div class="bottom-content">
                                    <a href="product-details.php" class="product-name">Painting Handicraft</a>
                                    <div class="action-wrap">
                                        <span class="product-price">$31.00</span>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item"><a class="collection-image" href="product-details.php"><img
                                        src="assets/images/products/home3/2.jpg" alt="collection-image"></a>
                                <div class="bottom-content">
                                    <a href="product-details.php" class="product-name">Wooden Handicraft</a>
                                    <div class="action-wrap">
                                        <span class="product-price">$31.00</span>
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item"><a class="collection-image" href="product-details.php"><img
                                        src="assets/images/products/home3/3.jpg" alt="collection-image"></a>
                                <div class="bottom-content">
                                    <a href="product-details.php" class="product-name">Balli Handicraft</a>
                                    <div class="action-wrap">
                                        <span class="product-price">$31.00</span>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item"><a class="collection-image" href="product-details.php"><img
                                        src="assets/images/products/home3/4.jpg" alt="collection-image"></a>
                                <div class="bottom-content">
                                    <a href="product-details.php" class="product-name">Minimalist Beard Mug</a>
                                    <div class="action-wrap">
                                        <span class="product-price">$31.00</span>
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item"><a class="collection-image" href="product-details.php"><img
                                        src="assets/images/products/home3/5.jpg" alt="collection-image"></a>
                                <div class="bottom-content">
                                    <a href="product-details.php" class="product-name">Minimalist Beard Mug</a>
                                    <div class="action-wrap">
                                        <span class="product-price">$31.00</span>
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item"><a class="collection-image" href="product-details.php"><img
                                        src="assets/images/products/home3/6.jpg" alt="collection-image"></a>
                                <div class="bottom-content">
                                    <a href="product-details.php" class="product-name">Classic Handicraft</a>
                                    <div class="action-wrap">
                                        <span class="product-price">$31.00</span>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-sm-6 box-widget-col">
                        <div class="footer-widget footer-box-widget">
                            <div class="footer-logo"><img src="assets/images/logo7.svg" alt="footer-logo"></div>
                            <p>Solid is the information & experience
                                directed at an end-user</p>
                            <div class="quick-contact">
                                <div class="phone contact-item">
                                    <div class="icon"><img src="assets/images/icons/24clock.png" alt="chat-icon">
                                    </div>
                                ...
                                <div class="email contact-item">
                                    <div class="icon"><img src="assets/images/icons/mail.png" alt="phone-icon">
                                    </div>
                                    <div class="contact-info">
