                                ...
                                <ul class="nav__menu">
                                    ...
                                    <li class="has-dropdown"><a class="menu-item" href="#">Blog <i
                                        ...
                                        <ul class="dropdown-ul">
                                            ...
                                            <li class="dropdown-li"><a class="dropdown-link" href="news-grid.php">Blog
                                                    Grid</a></li>
                                            <li class="dropdown-li"><a class="dropdown-link"
                        ...
                        <ul class="sub-menu mega-dropdown-mobile">
                            <li class="mega-dropdown-li">
                                <ul class="mega-dropdown-ul mm-show">
                                    ...
                                    <li class="dropdown-li"><a class="dropdown-link" href="slidebar-left.php">Left
                                            Sidebar
                                            Shop</a>
                                    </li>
                                    <li class="dropdown-li"><a class="dropdown-link" href="slidebar-right.php">Right
                                            Sidebar
                                            Shop</a>
                                    </li>
                            ...
                            <li class="mega-dropdown-li">
                                <ul class="mega-dropdown-ul mm-show">
                                    <li class="dropdown-li"><a class="dropdown-link" href="product-details.php">Single
                                            Product
                                            Layout
                                            One</a>
                                    </li>
                                    <li class="dropdown-li"><a class="dropdown-link" href="product-details2.php">Single
                                            Product Layout
                                            Two</a>
                                    </li>
                                    <li class="dropdown-li"><a class="dropdown-link"
                                            href="variable-products.php">Variable Product</a>
                                    </li>
                                    <li class="dropdown-li"><a class="dropdown-link"
                                            href="grouped-products.php">Grouped Product</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="mega-dropdown-li">
                                <ul class="mega-dropdown-ul mm-show">
                                    ...
                                    <li class="dropdown-li"><a class="dropdown-link" href="checkout.php">Checkout</a>
                                    </li>
                                    <li class="dropdown-li"><a class="dropdown-link" href="account.php">My
                                            Account</a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <div class="col-xl-2 col-lg-3 gutter-1">
                            <div class="catagory-sidebar">
                                <div class="widget-bg">
                                    ...
                                    <nav>
                                        <ul>
                                            <li><a href="shop.php">Women <i
                                                        class="rt rt-arrow-right-long"></i></a></li>
                                            <li><a href="shop.php">Man <i class="rt rt-arrow-right-long"></i></a>
                                            </li>
                                            <li><a href="shop.php">Kids <i class="rt rt-arrow-right-long"></i></a>
                                            </li>
                                            <li><a href="shop.php">Baby <i class="rt rt-arrow-right-long"></i></a>
                                            </li>
                                            <li><a href="shop.php">Shoes <i
                                                        class="rt rt-arrow-right-long"></i></a></li>
                                            <li><a href="shop.php">Watches <i class="rt rt-arrow-right-long"></i></a>
                                            </li>
                                            <li><a href="shop.php">Sunglass <i
                                                        class="rt rt-arrow-right-long"></i></a></li>
                                            <li><a href="shop.php">Wallet <i class="rt rt-arrow-right-long"></i></a>
                                            </li>
                                            <li><a href="shop.php">Best Seller <i class="rt rt-arrow-right-long"></i></a>
                                            </li>
                                            <li><a href="shop.php">Trending <i class="rt rt-arrow-right-long"></i></a>
                                            </li>
                                            <li><a href="shop.php">Featured <i class="rt rt-arrow-right-long"></i></a>
                                            </li>
                                            <li><a href="shop.php">Accesories <i class="rt rt-arrow-right-long"></i></a>
                                            </li>
                                            <li><a href="shop.php">Offer Deal <i class="rt rt-arrow-right-long"></i></a>
                                            </li>
                                        </ul>
                                    </nav>
                                </div>
                                                ...
                                                <div class="container header-container">
                                                    <div class="single-inner">
                                                        <div class="contents">
                                                            ...
                                                            <a class="banner-btn" href="shop.php">View Collection</a>
                                                        </div>
                                                        <div class="slider-image"><img src="assets/images/products/home9/model.png" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="single-inner">
                                                        <div class="contents">
                                                            ...
                                                            <h1 class="banner-heading">
                                                                New Floral Top</h1>
                                                            <p>Free shipping with our Special Service & not redeemable</p>
                                                            <a class="banner-btn" href="shop.php">View Collections</a>
                                                        </div>
                                                        <div class="slider-image"><img src="assets/images/products/home9/model-2.png" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="banner-single">
                                                <div class="container header-container">
                                                    <div class="single-inner">
                                                        ...
                                                        <div class="slider-image"><img src="assets/images/products/home9/image-slide-1.png" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <a href="product-details.php" class="product-box product-box-medium product-box-medium5">
                        ...
                        <div class="product-thumb"><img src="assets/images/products/home9/man1.png" alt="product-thumb">
                        </div>
                    </a>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <a href="product-details.php" class="product-box product-box-medium product-box-medium3">
                        ...
                        <div class="product-thumb"><img src="assets/images/products/home9/women1.png" alt="product-thumb">
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="rts-featured-product-section-inner">
                ...
                <div class="recent-products-header section-header section-header2">
                    <div class="filter-buttons-group section-header-item">
                        ...
                        <img src="assets/images/icons/filter1.png" alt="">
                    ...
                    <div class="row">
                            ...
                            <div class="product-item element-item1">
                                <a href="product-details.php" class="product-image image-hover-variations">
                                    <div class="image-vari1 image-vari"><img
                                            src="assets/images/products/home9/i-1.jpg" alt="product-image">
                                    </div>
                                    <div class="image-vari2 image-vari"><img
                                            src="assets/images/products/home9/i-1.1.jpg" alt="product-image">
                                    </div>
                                </a>
                                <div class="bottom-content">
                                    <a href="product-details.php" class="product-name">The Linen Workwear Blue T-shirt</a>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="product-item element-item1">
                                <a href="product-details.php" class="product-image image-hover-variations">
                                    <div class="image-vari1 image-vari"><img
                                            src="assets/images/products/home9/i-2.jpg" alt="product-image">
                                    </div>
                                    <div class="image-vari2 image-vari"><img
                                            src="assets/images/products/home9/i-2.2.jpg" alt="product-image">
                                    </div>
                                </a>
                                <div class="bottom-content">
                                    <a href="product-details.php" class="product-name">The Organic Cotton Cutaway Tank</a>
                                    <div class="action-wrap">
                                        <span class="price">$31.00</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="product-item element-item2">
                                <a href="product-details.php" class="product-image image-slider-variations">
                                    <div class="swiper productSlide">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="image-vari1 image-vari"><img
                                                        src="assets/images/products/home9/i-3.jpg"
                                                        alt="product-image">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="image-vari2 image-vari"><img
                                                        src="assets/images/products/home9/i-3.3.jpg"
                                                        alt="product-image">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="bottom-content">
                                    <a href="product-details.php" class="product-name">The Seersucker Midi Dress</a>
                                    <div class="action-wrap">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="product-item element-item1">
                                <a href="product-details.php" class="product-image image-hover-variations">
                                    <div class="image-vari1 image-vari"><img
                                            src="assets/images/products/home9/i-4.jpg" alt="product-image">
                                    </div>
                                    <div class="image-vari2 image-vari"><img
                                            src="assets/images/products/home9/i-4.4.jpg" alt="product-image">
                                    </div>
                                </a>
                                <div class="bottom-content">
                                    <a href="product-details.php" class="product-name">The Fatigue Barrel Black Pant</a>
                                    <div class="action-wrap">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="product-item element-item1">
                                <a href="product-details.php" class="product-image image-hover-variations">
                                    <div class="image-vari1 image-vari"><img
                                            src="assets/images/products/home9/i-5.jpg" alt="product-image">
                                    </div>
                                    <div class="image-vari2 image-vari"><img
                                            src="assets/images/products/home9/i-5.5.jpg" alt="product-image">
                                    </div>
                                </a>
                                <div class="bottom-content">
                                    <a href="product-details.php" class="product-name">The Linen Workwear Blue T-shirt</a>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="product-item element-item1">
                                <a href="product-details.php" class="product-image image-hover-variations">
                                    <div class="image-vari1 image-vari"><img
                                            src="assets/images/products/home9/i-6.jpg" alt="product-image">
                                    </div>
                                    <div class="image-vari2 image-vari"><img
                                            src="assets/images/products/home9/i-6.6.jpg" alt="product-image">
                                    </div>
                                </a>
                                <div class="bottom-content">
                                    <a href="product-details.php" class="product-name">The Linen Workwear Blue T-shirt</a>
                                ...
                                <a href="product-details.php" class="product-image image-slider-variations">
                                    <div class="swiper productSlide2">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="image-vari1 image-vari"><img
                                                        src="assets/images/products/home9/i-7.jpg"
                                                        alt="product-image">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="image-vari2 image-vari"><img
                                                        src="assets/images/products/home9/i-7.7.jpg"
                                                        alt="product-image">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                ...
                                <a href="product-details.php" class="product-image image-slider-variations">
                                    <div class="swiper productSlide3">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="image-vari1 image-vari"><img
                                                        src="assets/images/products/home9/i-8.jpg"
                                                        alt="product-image">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="image-vari2 image-vari"><img
                                                        src="assets/images/products/home9/i-8.8.jpg"
                                                        alt="product-image">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="product-item element-item1">
                                <a href="product-details.php" class="product-image image-hover-variations">
                                    <div class="image-vari1 image-vari"><img
                                            src="assets/images/products/home9/i-8.jpg" alt="product-image">
                                    </div>
                                    <div class="image-vari2 image-vari"><img
                                            src="assets/images/products/home9/i-8.8.jpg" alt="product-image">
                                    </div>
                                </a>
                                <div class="bottom-content">
                                    <a href="product-details.php" class="product-name">The Seersucker Midi Dress</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="product-item element-item1">
                                <a href="product-details.php" class="product-image image-hover-variations">
                                    <div class="image-vari1 image-vari"><img
                                            src="assets/images/products/home9/i-3.jpg" alt="product-image">
                                    </div>
                                    <div class="image-vari2 image-vari"><img
                                            src="assets/images/products/home9/i-3.3.jpg" alt="product-image">
                                    </div>
                                </a>
                                <div class="bottom-content">
                                    <a href="product-details.php" class="product-name">The Seersucker Midi Dress</a>
                                ...
                                <a href="product-details.php" class="product-image image-slider-variations">
                                    <div class="swiper productSlide2">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="image-vari1 image-vari"><img
                                                        src="assets/images/products/home9/i-2.jpg"
                                                        alt="product-image">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="image-vari2 image-vari"><img
                                                        src="assets/images/products/home9/i-2.2.jpg"
                                                        alt="product-image">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                ...
                                <a href="product-details.php" class="product-image image-slider-variations">
                                    <div class="swiper productSlide3">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="image-vari1 image-vari"><img
                                                        src="assets/images/products/home9/i-1.jpg"
                                                        alt="product-image">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="image-vari2 image-vari"><img
                                                        src="assets/images/products/home9/i-1.1.jpg"
                                                        alt="product-image">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="collection-item">
                                    <div class="image">
                                        <a href="category.php"><img src="assets/images/catagory/item-1.png" alt="collection-image"></a>
                                    </div>
                                    <div class="contents">
                            ...
                            <div class="swiper-slide">
                                <div class="collection-item">
                                    <div class="image">
                                        <a href="category.php"><img src="assets/images/catagory/item-2.png" alt="collection-image"></a>
                                    </div>
                                    <div class="contents">
                                        <p class="item-quantity">20 <span>items</span></p>
                                        <a href="category.php" class="item-catagory-box">
                            ...
                            <div class="swiper-slide">
                                <div class="collection-item">
                                    <div class="image">
                                        <a href="category.php"><img src="assets/images/catagory/item-3.png" alt="collection-image"></a>
                                    </div>
                                    <div class="contents">
                                        <p class="item-quantity">20 <span>items</span></p>
                                        <a href="category.php" class="item-catagory-box">
                            ...
                            <div class="swiper-slide">
                                <div class="collection-item">
                                    <div class="image">
                                        <a href="category.php"><img src="assets/images/catagory/item-4.png" alt="collection-image"></a>
                                    </div>
                                    <div class="contents">
                                        <p class="item-quantity">20 <span>items</span></p>
                                        <a href="category.php" class="item-catagory-box">
                ...
                <div class="row">
                    <div class="col-xl-9 col-lg-8 col-md-6 col-sm-12 pr">
                        ...
                        <div class="row justify-content-lg-center">
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6 border-bottom p-0">
                                <div class="wraper">
                                    <div class="image-section">
                                        <a href="product-details.php"><img src="assets/images/products/home9/product1.png" alt=""></a>
                                    </div>
                                    <div class="content">
                                        ...
                                        <a href="product-details.php" class="product-title">The Linen T-shirt</a>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6 border-bottom p-0">
                                <div class="wraper">
                                    <div class="image-section">
                                        <a href="product-details.php"><img src="assets/images/products/home9/product2.png" alt=""></a>
                                    </div>
                                    <div class="content">
                                        <div class="star-rating">
                                            <ul>
                                        ...
                                        <a href="product-details.php" class="product-title">The Cotton Cutaway</a>
                                        <p class="product-price">$21.00</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6 border-bottom p-0">
                                <div class="wraper border-0">
                                    <div class="image-section">
                                        <a href="product-details.php"><img src="assets/images/products/home9/product3.png" alt=""></a>
                                    </div>
                                    <div class="content last">
                                        ...
                                        <a href="product-details.php" class="product-title">The Seersucker Dress</a>
                                        <p class="product-price">$21.00</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6 border-bottom p-0">
                                <div class="wraper">
                                    <div class="image-section">
                                        <a href="product-details.php"><img src="assets/images/products/home9/product4.png" alt=""></a>
                                    </div>
                                    <div class="content">
                                        <div class="star-rating">
                                            <ul>
                                        ...
                                        <a href="product-details.php" class="product-title">The Fatigue Sunglass</a>
                                        <p class="product-price">$21.00</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6 border-bottom p-0">
                                <div class="wraper">
                                    <div class="image-section">
                                        <a href="product-details.php"><img src="assets/images/products/home9/product5.png" alt=""></a>
                                    </div>
                                    <div class="content">
                                        <div class="star-rating">
                                            <ul>
                                        ...
                                        <a href="product-details.php" class="product-title">The Fatigue Shoe</a>
                                        <p class="product-price">$21.00</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6 border-bottom p-0">
                                <div class="wraper border-0">
                                    <div class="image-section">
                                        <a href="product-details.php"><img src="assets/images/products/home9/product6.png" alt=""></a>
                                    </div>
                                    <div class="content last">
                                        <div class="star-rating">
                                            <ul>
                                        ...
                                        <a href="product-details.php" class="product-title">The Fatigue Shirt</a>
                                        <p class="product-price">$21.00</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6 p-0">
                                <div class="wraper last-child">
                                    <div class="image-section">
                                        <a href="product-details.php"><img src="assets/images/products/home9/product7.png" alt=""></a>
                                    </div>
                                    <div class="content">
                                        <div class="star-rating">
                                            <ul>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6 p-0">
                                <div class="wraper last-child">
                                    <div class="image-section">
                                        <a href="product-details.php"><img src="assets/images/products/home9/product8.png" alt=""></a>
                                    </div>
                                    <div class="content">
                                        <div class="star-rating">
                                            <ul>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6 p-0">
                                <div class="wraper last-child border-0">
                                    <div class="image-section">
                                        <a href="product-details.php"><img src="assets/images/products/home9/product9.png" alt=""></a>
                                    </div>
                                    <div class="content last">
                                        <div class="star-rating">
                                            <ul>
                                        ...
                                        <a href="product-details.php" class="product-title">The Fatigue Slipper</a>
                                        <p class="product-price">$21.00</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 p-0">
                        <div class="right-side-banner">
                            <img src="assets/images/products/home9/product-banner.png" alt="">
                            <div class="banner-content text-center">
                                <p class="title">Hot monthly deal</p>
                                <h3 class="main-title">Save an extra $25 <br> per order</h3>
                                <a href="shop.php" class="shopnow-btn">Shop Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="item-box">
                                        <div class="image">
                                            <a href="product-details.php">
                                                <img src="assets/images/products/home9/product10.png" alt="">
            ...
            <div class="section-inner">
                <div class="row align-items-center">
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 text-center">
                        <div class="image">
                            <img src="assets/images/products/home9/company1.png" alt="">
                        </div>
                        <div class="content">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 text-center">
                        <div class="image">
                            <img src="assets/images/products/home9/company2.png" alt="">
                        </div>
                        <div class="content">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 text-center">
                        <div class="image">
                            <img src="assets/images/products/home9/company3.png" alt="">
                        </div>
                        <div class="content">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 text-center">
                        <div class="image">
                            <img src="assets/images/products/home9/company4.png" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/products/home9/i-9.jpg" alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img
                                        src="assets/images/products/home9/i-9.9.jpg" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">The Organic Cotton Cutaway Tank</a>
                            ...
                            <a href="product-details.php" class="product-image image-slider-variations">
                                <div class="swiper productSlide">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="image-vari1 image-vari"><img
                                                    src="assets/images/products/home9/i-10.jpg"
                                                    alt="product-image">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="image-vari2 image-vari"><img
                                                    src="assets/images/products/home9/i-10.10.jpg"
                                                    alt="product-image">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/products/home9/i-11.jpg" alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img
                                        src="assets/images/products/home9/i-11.11.jpg" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">The Fatigue Barrel Black Pant</a>
                ...
                <div class="swiper rts-cmmnSlider-over3" data-swiper="navigation">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="collection-item">
                                <div class="image">
                                    <img src="assets/images/products/home9/catagories1.png" alt="">
                                </div>
                                <div class="content">
                                    <h3 class="title">Mens Wear</h3>
                                    <ul>
                                        <li><a href="product-details.php">Tshirt <span>(185)</span></a></li>
                                        <li><a href="product-details.php">Geans <span>(325)</span></a></li>
                                        <li><a href="product-details.php">Shoes <span>(690)</span></a></li>
                                    </ul>
                                    <a href="product-details.php" class="view-button">View All <i class="rt-arrow-right-long"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="collection-item">
                                <div class="image">
                                    <img src="assets/images/products/home9/catagories2.png" alt="">
                                </div>
                                <div class="content">
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item">
                                <div class="image">
                                    <img src="assets/images/products/home9/catagories3.png" alt="">
                                </div>
                                <div class="content">
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="full-wrapper wrapper-1">
                            <div class="image-part">
                                <a href="#" class="image"><img src="assets/images/products/home9/blog1.png"
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="full-wrapper wrapper-2">
                            <div class="image-part">
                                <a href="#" class="image"><img src="assets/images/products/home9/blog2.png"
                                        alt="Featured Image"></a>
                            </div>
                            <div class="blog-content">
                                <span class="date-full">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="full-wrapper wrapper-3">
                            <div class="image-part">
                                <a href="#" class="image"><img src="assets/images/products/home9/blog3.png"
                                        alt="Featured Image"></a>
                            </div>
                            <div class="blog-content">
                                <span class="date-full">
