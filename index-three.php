...
<?php $css = '<link rel="stylesheet" href="assets/css/variables/variable2.css">';?>
        ...
        <div class="header-topbar header-topbar2">
            <div class="container header-container">
                <div class="header-top-inner">
                    <a href="newsletter.php" class="newsletter-link"><i class="rt-envelope"></i> Newsletter</a>
            ...
            <div class="container header-container">
                <div class="navbar-part navbar-part2">
                    <div class="navbar-inner">
                        <a href="index.php" class="logo"><img src="assets/images/logo2.svg" alt="umart-logo"></a>
                        <div class="rts-menu">
                                ...
                                <ul class="nav__menu">
                                    <li class="has-dropdown"><a class="menu-item active1" href="#">Home <i
                                        ...
                                        <ul class="dropdown-ul">
                                            <li class="dropdown-li"><a class="dropdown-link" href="index.php">Main
                                                Home</a>
                                            </li>
                                    ...
                                    <li class="has-dropdown"><a class="menu-item" href="#">Shop <i
                                        ...
                                        <ul class="dropdown-ul mega-dropdown">
                                            ...
                                            <li class="mega-dropdown-li">
                                                <ul class="mega-dropdown-ul">
                                                    <li class="dropdown-li"><a class="dropdown-link"
                                                            href="product-details.php">Single Product Layout
                                                            One</a>
                                                    </li>
                                                    <li class="dropdown-li"><a class="dropdown-link"
                                            ...
                                            <li class="mega-dropdown-li last-child">
                                                <ul class="mega-dropdown-ul">
                                                    <li class="dropdown-li"><a class="dropdown-link"
                                                            href="simple-products.php">Cart</a>
                                                    </li>
                                                    <li class="dropdown-li"><a class="dropdown-link"
                                                            href="variable-products.php">Checkout</a>
                                                    </li>
                                                    <li class="dropdown-li"><a class="dropdown-link"
                                                            href="out-of-stock-products.php">My Account</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                    ...
                                    <li class="has-dropdown"><a class="menu-item" href="#">Pages <i
                                        ...
                                        <ul class="dropdown-ul">
                                            ...
                                            <li class="dropdown-li"><a class="dropdown-link"
                                                    href="category.php">FAQ's</a></li>
                                            <li class="dropdown-li"><a class="dropdown-link"
                                                    href="wishlist.php">Error 404</a></li>
                                        </ul>
                                    </li>
                        ...
                        <div class="header-action-items header-action-items1">
                            ...
                            <div class="wishlist action-item">
                                <div class="favourite-icon icon"><a href="wishlist.php"><i
                            ...
                            <div class="container header-container">
                                <div class="single-inner">
                                    <div class="contents">
                                        ...
                                        <a class="banner-btn" href="shop.php">Shop Now <i
                                                class="rt-arrow-right-long"></i></a>
                                    </div>
                                    <div class="slider-image"><img src="assets/images/products/home3/s2-1.webp" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="banner-single">
                            <div class="container header-container">
                                <div class="single-inner">
                                    ...
                                    <div class="slider-image"><img src="assets/images/products/home3/s20-3.webp" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="banner-single">
                            <div class="container header-container">
                                <div class="single-inner">
                                    ...
                                    <div class="slider-image"><img src="assets/images/products/home3/s41.webp" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-4 col-sm-6 col-12 shop">
                    <div class="shop-now-box shop-now-box2 collection-section-item box-1">
                        <a href="category.php" class="picture"><img src="assets/images/products/home3/s19-2.webp"
                                alt="shop-now"></a>
                        <div class="contents">
                            <h4 class="collection-text2">Collection AW 2024</h4>
                            <h2 class="title">Table & Lamps</h2>
                            <a href="shop.php" class="shop-now-btn shop-now-btn1">Shop now <i
                ...
                <div class="col-xl-4 col-md-4 col-sm-6 col-12 shop">
                    <div class="shop-now-box shop-now-box2 collection-section-item box-2">
                        <a href="category.php" class="box-bg"><img src="assets/images/products/home3/s20.webp"
                                alt="boxbg"></a>
                        <div class="contents">
                            <h4 class="collection-text2">Collection AW 2024</h4>
                ...
                <div class="col-xl-4 col-md-4 col-sm-6 col-12 shop">
                    <div class="shop-now-box shop-now-box2 collection-section-item box-3">
                        <a href="category.php" class="picture"><img src="assets/images/products/home3/s16.webp"
                                alt="shop-now"></a>
                        <div class="contents">
                            <h4 class="collection-text2">Collection AW 2024</h4>
                ...
                <div class="row">
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img src="assets/images/products/home2/1.jpg"
                                        alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img src="assets/images/products/home2/1_2.jpg"
                                        alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Dining Chair</a>
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item2">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="image-vari1 image-vari"><img
                                                    src="assets/images/products/home2/2.jpg" alt="product-image">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="image-vari2 image-vari"><img
                                                    src="assets/images/products/home2/2_1.jpg" alt="product-image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Bauhaus chair</a>
                                <div class="action-wrap">
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item3 popular">
                            <a href="product-details.php" class="product-image image-gallery-variations">
                                <div class="swiper productGallerySlide">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="image-vari1 image-vari"><img
                                                    src="assets/images/products/home2/3.jpg" alt="product-image">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="image-vari2 image-vari"><img
                                                    src="assets/images/products/home2/3_1.jpg" alt="product-image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Aeron Dining Chair</a>
                                <div class="action-wrap">
                                    <span class="product-price">$31.00 <span class="old-price">$43.00</span></span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                                        Cart</a>
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img src="assets/images/products/home2/4.jpg"
                                        alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img src="assets/images/products/home2/4_1.jpg"
                                        alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Italian Leather Band Watch</a>
                                <div class="action-wrap">
                                    <span class="product-price">$31.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                                        Cart</a>
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img src="assets/images/products/home2/5.jpg"
                                        alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img src="assets/images/products/home2/5_1.jpg"
                                        alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Trending Accent Chair</a>
                                <div class="action-wrap">
                                    <span class="product-price">$31.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                                        Cart</a>
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img src="assets/images/products/home2/6.jpg"
                                        alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img src="assets/images/products/home2/6_1.jpg"
                                        alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Wooden Stylish Chair</a>
                                <div class="action-wrap">
                                    <span class="product-price">$31.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                                        Cart</a>
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img src="assets/images/products/home2/7.jpg"
                                        alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img src="assets/images/products/home2/7_1.jpg"
                                        alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img src="assets/images/products/home2/8.jpg"
                                        alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img src="assets/images/products/home2/8_1.jpg"
                                        alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Office Chair</a>
                                <div class="action-wrap">
                                    <span class="product-price">$31.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                                        Cart</a>
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item2">
                            <a href="product-details.php" class="product-image image-slider-variations">
                                <div class="swiper productSlide2">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="image-vari1 image-vari"><img
                                                    src="assets/images/products/home2/9.jpg" alt="product-image">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="image-vari2 image-vari"><img
                                                    src="assets/images/products/home2/9_1.jpg" alt="product-image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Scandinavian Oak Chair</a>
                                <div class="action-wrap">
                                    <span class="product-price">$31.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                                        Cart</a>
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item3 popular">
                            <a href="product-details.php" class="product-image image-gallery-variations">
                                <div class="swiper productGallerySlide2">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="image-vari1 image-vari"><img
                                                    src="assets/images/products/home2/10.jpg" alt="product-image">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="image-vari2 image-vari"><img
                                                    src="assets/images/products/home2/10_1.jpg" alt="product-image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Stylish Office chair</a>
                                <div class="action-wrap">
                                    <span class="product-price">$31.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                                        Cart</a>
                ...
                <div class="row">
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item1">
                            ...
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Adapt Camo Seamless Shorts</a>
                                <div class="action-wrap">
                                    <span class="product-price">$31.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                                        Cart</a>
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img src="assets/images/products/home2/2.jpg"
                                        alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img src="assets/images/products/home2/2_1.jpg"
                                        alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img src="assets/images/products/home2/3.jpg"
                                        alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img src="assets/images/products/home2/3_1.jpg"
                                        alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img src="assets/images/products/home2/9.jpg"
                                        alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img src="assets/images/products/home2/9_1.jpg"
                                        alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img src="assets/images/products/home2/10.jpg"
                                        alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img src="assets/images/products/home2/10_1.jpg"
                                        alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item1">
                            ...
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Marl Seamless Long Sleeve Crop
                                    Top</a>
                                <div class="action-wrap">
                                    <span class="product-price">$31.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item1">
                            ...
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Seamless Sports Bra Smokey Grey
                                    Mar</a>
                                <div class="action-wrap">
                                    <span class="product-price">$31.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                    ...
                    <div class="col-lg-15 col-md-4 col-sm-6">
                        <div class="product-item element-item1">
                            ...
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Vital Seamless 2.0 Vest Yellow
                                    Marl</a>
                                <div class="action-wrap">
                                    <span class="product-price">$31.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="full-wrapper wrapper-1">
                            <div class="image-part">
                                <a href="#" class="image"><img src="assets/images/featured/img-1.jpg"
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="full-wrapper wrapper-2">
                            <div class="image-part">
                                <a href="#" class="image"><img src="assets/images/featured/img-2.jpg"
                                        alt="Featured Image"></a>
                            </div>
                            <div class="blog-content">
                                <span class="date-full date-full2">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="full-wrapper wrapper-3">
                            <div class="image-part">
                                <a href="#" class="image"><img src="assets/images/featured/img-3.jpg"
                                        alt="Featured Image"></a>
                            </div>
                            <div class="blog-content">
                                <span class="date-full date-full2">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6">
                        <div class="feature-item">
                            <div class="icon"><img src="assets/images/icons/box.svg" alt="icon"></div>
                            <div class="content">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="feature-item">
                            <div class="icon"><img src="assets/images/icons/delivery-van.svg" alt="icon"></div>
                            <div class="content">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="feature-item">
                            <div class="icon"><img src="assets/images/icons/credit-card.svg" alt="icon"></div>
                            <div class="content">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="feature-item last-child">
                            <div class="icon"><img src="assets/images/icons/24hours.svg" alt="icon"></div>
                            <div class="content">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-sm-6">
                        <div class="footer-widget">
                            <div class="footer-logo"><img src="assets/images/logo6.svg" alt="footer-logo"></div>
                            ...
                            <div class="quick-contact">
                                <div class="phone contact-item">
                                    <div class="icon"><img src="assets/images/icons/bubble-chat2.svg" alt="chat-icon">
                                    </div>
                                ...
                                <div class="email contact-item">
                                    <div class="icon"><img src="assets/images/icons/telephone-call2.svg"
                                            alt="phone-icon">
                                    </div>
                            ...
                            <div class="ig-feed">
                                <div class="row">
                                    <div class="col-xl-4 col-md-4 col-sm-4 col-6"><a href="#0" class="feed-item"><img
                                                src="assets/images/footer/feed.jpg" alt="ig-feed"><i
                                                class="fab fa-instagram"></i></a></div>
                                    <div class="col-xl-4 col-xl-4 col-md-4 col-sm-4 col-6"><a href="#0"
                                            class="feed-item"><img src="assets/images/footer/feed-1.jpg"
                                                alt="ig-feed"><i class="fab fa-instagram"></i></a></div>
                                    <div class="col-xl-4 col-xl-4 col-md-4 col-sm-4 col-6"><a href="#0"
                                            class="feed-item"><img src="assets/images/footer/feed-2.jpg"
                                                alt="ig-feed"><i class="fab fa-instagram"></i></a></div>
                                    <div class="col-xl-4 col-xl-4 col-md-4 col-sm-4 col-6"><a href="#0"
                                            class="feed-item"><img src="assets/images/footer/feed-3.jpg"
                                                alt="ig-feed"><i class="fab fa-instagram"></i></a></div>
                                    <div class="col-xl-4 col-xl-4 col-md-4 col-sm-4 col-6"><a href="#0"
                                            class="feed-item"><img src="assets/images/footer/feed-4.jpg"
                                                alt="ig-feed"><i class="fab fa-instagram"></i></a></div>
                                    <div class="col-xl-4 col-xl-4 col-md-4 col-sm-4 col-6"><a href="#0"
                                            class="feed-item"><img src="assets/images/footer/feed-5.jpg"
                                                alt="ig-feed"><i class="fab fa-instagram"></i></a></div>
                                </div>
                            </div>
                        </div>
