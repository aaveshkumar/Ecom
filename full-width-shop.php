                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-3 col-md-4 col-sm-6">
                                <div class="product-item product-item2 element-item3">
                                    <a href="product-details.php" class="product-image">
                                        <img src="assets/images/hand-picked/slider-img8_2.jpg" alt="product-image">
                                    </a>
                                    <div class="bottom-content">
                                        <a href="product-details.php" class="product-name">Men’s Canvas</a>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6">
                                <div class="product-item product-item2 element-item2">
                                    ...
                                    <div class="bottom-content">
                                        <a href="product-details.php" class="product-name">Woman’s Blouse</a>
                                        <div class="action-wrap">
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6">
                                <div class="product-item product-item2 element-item3 popular">
                                    ...
                                    <div class="bottom-content">
                                        <a href="product-details.php" class="product-name">Girl's Tops</a>
                                        <div class="action-wrap">
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6">
                                <div class="product-item product-item2 element-item1">
                                    <a href="product-details.php" class="product-image">
                                        <img src="assets/images/hand-picked/slider-img14.webp" alt="product-image">
                                    </a>
                                    <div class="bottom-content">
                                        <a href="product-details.php" class="product-name">Legacy Leather Sneaker</a>
                                        <div class="action-wrap">
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6">
                                <div class="product-item product-item2 element-item1">
                                    <a href="product-details.php" class="product-image">
                                        <img src="assets/images/hand-picked/slider-img12-1.webp" alt="product-image">
                                    </a>
                                    <div class="bottom-content">
                                        <a href="product-details.php" class="product-name">Chloe by Karl Lagerfeld</a>
                                        <div class="action-wrap">
                                            <span class="product-price">$310.00</span>
                                            <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                                                Cart</a>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6">
                                <div class="product-item product-item2 element-item1">
                                    <a href="product-details.php" class="product-image">
                                        <img src="assets/images/hand-picked/slider-img12-2.webp" alt="product-image">
                                    </a>
                                    <div class="bottom-content">
                                        <a href="product-details.php" class="product-name">Vintage Grey Wool</a>
                                        <div class="action-wrap">
                                            <span class="product-price">$270.00</span>
                                            <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add To
                                                Cart</a>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6">
                                <div class="product-item product-item2 element-item1">
                                    <a href="product-details.php" class="product-image">
                                        <img src="assets/images/hand-picked/slider-img12-3.webp" alt="product-image">
                                    </a>
                                    <div class="bottom-content">
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6">
                                <div class="product-item product-item2 element-item1">
                                    <a href="product-details.php" class="product-image">
                                        <img src="assets/images/hand-picked/slider-img12.webp" alt="product-image">
                                    </a>
                                    <div class="bottom-content">
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6">
                                <div class="product-item product-item2 element-item1">
                                    <a href="product-details.php" class="product-image">
                                        <img src="assets/images/hand-picked/slider-img13.webp" alt="product-image">
                                    </a>
                                    <div class="bottom-content">
                                        <a href="product-details.php" class="product-name">Minimalist Beard Mug</a>
                                        <div class="action-wrap">
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6">
                                <div class="product-item product-item2 element-item1">
                                    <a href="product-details.php" class="product-image">
                                        <img <img src="assets/images/hand-picked/slider-img11_1.webp" alt="product-image">
                                    </a>
                                    <div class="bottom-content">
                                        <a href="product-details.php" class="product-name">Minimalist Beard Mug</a>
                                        <div class="action-wrap">
