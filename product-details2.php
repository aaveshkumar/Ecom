    ...
    <div class="rts-product-details-section rts-product-details-section2 section-gap">
        <div class="container">
            <div class="row product-row">
                <div class="col-lg-25">
                    <h5 class="mb--30">Related Products</h5>
                    <div class="product-area side-products">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/hand-picked/slider-img8_2.jpg" alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img
                                        src="assets/images/hand-picked/slider-img8_3.jpg" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                ...
                                <div class="action-wrap">
                                    ...
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add
                                        To
                                        Cart</a>
                                </div>
                            </div>
                        ...
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/hand-picked/woman-shirt-338x450.png" alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img
                                        src="assets/images/hand-picked/woman-shirt-2.jpg" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Adapt Camo Seamless Shorts</a>
                ...
                <div class="col-xl-9">
                    <div class="product-area details-product-area mb--70">
                        <div class="product-thumb-area">
                            <div class="cursor"></div>
                            <div class="thumb-wrapper one filterd-items figure">
                                <div class="product-thumb zoom" onmousemove="zoom(event)"
                                    style="background-image: url(assets/images/hand-picked/slider-img8_2.jpg)"><img
                                        src="assets/images/hand-picked/slider-img8_2.jpg" alt="product-thumb">
                                </div>
                            </div>
                            <div class="thumb-wrapper two filterd-items hide">
                                <div class="product-thumb zoom" onmousemove="zoom(event)"
                                    style="background-image: url(assets/images/hand-picked/woman-shirt-338x450.png)"><img
                                        src="assets/images/hand-picked/woman-shirt-338x450.png" alt="product-thumb">
                                </div>
                            </div>
                            <div class="thumb-wrapper three filterd-items hide">
                                <div class="product-thumb zoom" onmousemove="zoom(event)"
                                    style="background-image: url(assets/images/hand-picked/slider-img12-3.webp)"><img
                                        src="assets/images/hand-picked/slider-img12-3.webp" alt="product-thumb">
                                </div>
                            </div>
                            <div class="product-thumb-filter-group">
                                <div class="thumb-filter filter-btn active" data-show=".one"><img
                                        src="assets/images/hand-picked/slider-img8_2.jpg" alt="product-thumb-filter"></div>
                                <div class="thumb-filter filter-btn" data-show=".two"><img
                                        src="assets/images/hand-picked/woman-shirt-2.jpg" alt="product-thumb-filter"></div>
                                <div class="thumb-filter filter-btn" data-show=".three"><img
                                        src="assets/images/hand-picked/slider-img12-3.webp" alt="product-thumb-filter"></div>
                            </div>
                        </div>
                        <div class="contents">
                            ...
                            <div class="product-bottom-action">
                                ...
                                <a href="cart.php" class="addto-cart-btn action-item"><i
                                        class="rt-basket-shopping"></i> Add To
                                    Cart</a>
                            ...
                            <div class="col-lg-12 col-md-12 mr-10">
                                <div class="reveiw-form">
                                    <h2 class="section-title">
                                        Be the first to reveiw <strong> <a href="product-details.php">"Wide Cotton
