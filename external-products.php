                ...
                <div class="col-xl-12">
                    <div class="product-area details-product-area mb--70 justify-content-center">
                        <div class="product-thumb-area">
                            ...
                            <div class="thumb-wrapper one filterd-items figure">
                                <div class="product-thumb zoom" onmousemove="zoom(event)"
                                    style="background-image: url(assets/images/products/product-filt1.jpg)"><img
                                        src="assets/images/products/product-filt1.jpg" alt="product-thumb">
                                </div>
                            </div>
                        ...
                        <div class="contents">
                            ...
                            <div class="product-bottom-action2">
