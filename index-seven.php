...
<?php $css = '<link rel="stylesheet" href="assets/css/variables/variable7.css">';?>
            ...
            <div class="container">
                <div class="navbar-part navbar-part1 navbar-part5">
                    <div class="navbar-inner">
                        <div class="left-side">
                            <a href="index.php" class="logo"><img src="assets/images/logo8.svg" alt="weiboo-logo"></a>
                        </div>
                        <div class="rts-menu">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                            <div class="product-item2 element-item2">
                                <a href="product-details.php" class="product-image2 image-slider-variations">
                                    <img src="assets/images/banner/banner-img.webp" alt="">
                                </a>
                            </div>
                        </div>
                                                ...
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide">
                                                        <div class="image-vari1 image-vari"><img
                                                                src="assets/images/banner/foot-7-338x450.webp"
                                                                alt="product-image">
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="image-vari2 image-vari"><img
                                                                src="assets/images/hand-picked/slider-img8_3.jpg"
                                                                alt="product-image">
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="product-item7">
                            ...
                            <div class="bottom-text">
                                ...
                                <a href="shop.php" class="btn-text">SHOP NOW</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/products/home7/footwear-1-410x410.webp" alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img
                                        src="assets/images/products/home7/foot-2-410x410.webp" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Lather Men's Canvas</a>
                                <div class="action-wrap">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item2">
                            <a href="product-details.php" class="product-image image-slider-variations">
                                <div class="swiper productSlide">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="image-vari1 image-vari"><img
                                                    src="assets/images/products/home7/foot-10-410x410.webp"
                                                    alt="product-image">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="image-vari2 image-vari"><img
                                                    src="assets/images/products/home7/foot-12-410x410.webp"
                                                    alt="product-image">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Shot Men's Canvas</a>
                                <div class="action-wrap">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/products/home7/foot-6-410x410.webp" alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img
                                        src="assets/images/products/home7/foot-9-410x410.webp" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Lather Men's Shoe Bra</a>
                                <div class="action-wrap">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/products/home7/foot-8-410x410.webp" alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img
                                        src="assets/images/products/home7/foot-11-410x410.webp" alt="product-image">
                                </div>
                            </a>
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Women's Canvas</a>
                                <div class="action-wrap">
                                    <span class="price">$220.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add to Cart</a>
                                </div>
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            <a href="product-details.php" class="product-image image-hover-variations">
                                <div class="image-vari1 image-vari"><img
                                        src="assets/images/products/home7/foot-3-410x410.webp" alt="product-image">
                                </div>
                                <div class="image-vari2 image-vari"><img
                                        src="assets/images/products/home7/foot-9-410x410.webp" alt="product-image">
                                </div>
                            ...
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Legacy Lather Sneaker</a>
                                <div class="action-wrap">
                            ...
                            <a href="product-details.php" class="product-image image-slider-variations">
                                <div class="swiper productSlide2">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="image-vari1 image-vari"><img
                                                    src="assets/images/products/home7/foot-5-410x410.webp"
                                                    alt="product-image">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            ...
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Lather Men's Lofer</a>
                                <div class="action-wrap">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item element-item1">
                            ...
                            <div class="bottom-content">
                                <a href="product-details.php" class="product-name">Sprint Men's Canvas</a>
                                <div class="action-wrap">
                                    <span class="price">$220.00</span>
                                    <a href="cart.php" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add to Cart</a>
                                </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-sm-6">
                        <div class="footer-widget">
                            <div class="footer-logo"><img src="assets/images/logo9.svg" alt="footer-logo"></div>
