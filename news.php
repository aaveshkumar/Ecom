                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="feed-item2">
                                    <a href="news-details.php" class="feed-image"><img
                                            src="assets/images/featured/img-1.jpg" alt="feed-image"></a>
                                    <div class="feed-content">
                                        <span class="feed-catagory">Winter Dress</span>
                                        <div class="author"><img src="assets/images/featured/author.png" alt=""> PixcelsThemes</div>
                                        <h2 class="feed-title"><a href="news-details.php">Once determined you need to come up with a name</a></h2>
                            ...
                            <div class="col-xl-12">
                                <div class="feed-item2">
                                    <a href="news-details.php" class="feed-image"><img
                                            src="assets/images/featured/img-2.jpg" alt="feed-image"></a>
                                    <div class="feed-content">
                                        <span class="feed-catagory">Winter Dress</span>
                                        <div class="author"><img src="assets/images/featured/author.png" alt=""> PixcelsThemes</div>
                                        <h2 class="feed-title"><a href="news-details.php">Legal structure, can make profit buisness</a></h2>
                            ...
                            <div class="col-xl-12">
                                <div class="feed-item2">
                                    <a href="news-details.php" class="feed-image"><img
                                            src="assets/images/featured/img-3.jpg" alt="feed-image"></a>
                                    <div class="feed-content">
                                        <span class="feed-catagory">Winter Dress</span>
                                        <div class="author"><img src="assets/images/featured/author.png" alt=""> PixcelsThemes</div>
                                        <h2 class="feed-title"><a href="news-details.php">At the limit, statically generated, edge a food</a></h2>
                                        <p>Re-engagement — objectives. As developers, we rightfully obsess about the customer experience, relentlessly working to squeeze every millisecond out of the critical rendering path, optimize input latency, and eliminate...</p>
                                        <div class="feed-info">
                                            <span class="feed-date">
                                            <i class="rt-calendar-days"></i> March 23, 2021</span>
                            ...
                            <div class="col-xl-12">
                                <div class="feed-item2">
                                    <a href="news-details.php" class="feed-image"><img
                                            src="assets/images/blog/img-1.jpg" alt="feed-image"></a>
                                    <div class="feed-content">
                                        <span class="feed-catagory">Smart Dress</span>
                                        <div class="author"><img src="assets/images/featured/author.png" alt=""> PixcelsThemes</div>
                                        <h2 class="feed-title"><a href="news-details.php">Best red carpet looks from the NAACP image Awards is nominate.</a></h2>
                            ...
                            <div class="col-xl-12">
                                <div class="feed-item2">
                                    <a href="news-details.php" class="feed-image"><img
                                            src="assets/images/blog/img-2.jpg" alt="feed-image"></a>
                                    <div class="feed-content">
                                        <span class="feed-catagory">Smart Dress</span>
                                        <div class="author"><img src="assets/images/featured/author.png" alt=""> PixcelsThemes</div>
                                        <h2 class="feed-title"><a href="news-details.php">Cloth red carpet looks from the ACP image Awards is worldwide.</a></h2>
                                        <p>A great commerce experience cannot be distilled to a single number. It’s not a Lighthouse score, or a set of Core Web Vitals figures, although both are important inputs....</p>
                                        <div class="feed-info">
                            ...
                            <div class="col-xl-12">
                                <div class="feed-item2">
                                    <a href="news-details.php" class="feed-image"><img
                                            src="assets/images/blog/img-3.jpg" alt="feed-image"></a>
                                    <div class="feed-content">
                                        <span class="feed-catagory">Smart Dress</span>
                                        <div class="author"><img src="assets/images/featured/author.png" alt=""> PixcelsThemes</div>
                                        <h2 class="feed-title"><a href="news-details.php">Modern young boy looks from the nice image position is late.</a></h2>
                                        <p>A great commerce experience cannot be distilled to a single number. It’s not a Lighthouse score, or a set of Core Web Vitals figures, although both are important inputs....</p>
                                        <div class="feed-info">
                                            <span class="feed-date">
                                            <i class="rt-calendar-days"></i> March 23, 2021</span>
                            ...
                            <ul class="post-list">
                                <li>
                                    <div class="blog-post mb-30">
                                        <a href="news-details.php"><img src="assets/images/blog/img-14.jpg" alt="Post Img"></a>
                                        <div class="post-content">
                                            <h6 class="mb-10"><a href="news-details.php">Having education in
                                                    an area helps</a></h6>
                                ...
                                <li>
                                    <div class="blog-post mb-30">
                                        <a href="news-details.php"><img src="assets/images/blog/img-15.jpg" alt="Post Img"></a>
                                        <div class="post-content">
                                            <h6 class="mb-10"><a href="news-details.php">People think, feel, &
                                ...
                                <li>
                                    <div class="blog-post mb-30">
                                        <a href="news-details.php"><img src="assets/images/blog/img-16.jpg" alt="Post Img"></a>
                                        <div class="post-content">
                                            <h6 class="mb-10"><a href="news-details.php">That contributes to
                                                    their success</a></h6>
                                            <span class="fs-14"><i class="fal fa-calendar-alt"></i> 24th March
                                                2024</span>
                                        </div>
                                ...
                                <li>
                                    <div class="blog-post">
                                        <a href="news-details.php"><img src="assets/images/blog/img-17.jpg" alt="Post Img"></a>
                                        <div class="post-content">
                                            <h6 class="mb-10"><a href="news-details.php">Improves not only
                                                    their personal</a></h6>
                                            <span class="fs-14"><i class="fal fa-calendar-alt"></i> 24th March
                                                2024</span>
                                        </div>
