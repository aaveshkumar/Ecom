...
<?php $css = '<link rel="stylesheet" href="assets/css/variables/variable10.css">';?>
            ...
            <div class="container">
                <div class="header-top-area">
                    <div class="header-top-left">
                        <a href="newsletter.php" class="newsletter-link"><i class="rt rt-location-dot"></i> Store Locator</a>
            ...
            <div class="container">
                <div class="navbar-part navbar-part1 navbar-part5">
                    <div class="navbar-inner">
                        <div class="left-side">
                            <a href="index.php" class="logo"><img src="assets/images/logo10.png" alt="weiboo-logo"></a>
                        </div>
                        <div class="rts-menu">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 p-0">
                            <div class="product-item2 element-item2">
                                <a href="product-details.php" class="product-image2 image-slider-variations">
                                    <img src="assets/images/products/home10/banner-img.png" alt="">
                                </a>
                            </div>
                        </div>
                                    ...
                                    <div class="product-item element-item2">
                                        <a href="product-details.php" class="product-image image-slider-variations">
                                            ...
                                            <div class="image-vari1 image-vari"><img
                                                    src="assets/images/products/home10/product1.png"
                                                    alt="product-image">
                                            </div>
                                        </a>
                                        <div class="bottom-content">
                                            ...
                                            <a href="product-details.php" class="product-name">Apex Men's Shoe</a>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <a href="product-details.php" class="product-box product-box-medium product-box-medium5">
                        <div class="product-image product-image1">
                            <img src="assets/images/products/home10/women.png" alt="">
                        </div>
                        <div class="contents">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                    <a href="product-details.php" class="product-box product-box-medium product-box-medium3">
                        ...
                        <div class="product-image">
                            <img src="assets/images/products/home10/product2.png" alt="">
                        </div>
                    </a>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                    <a href="product-details.php" class="product-box product-box-medium product-box-medium3">
                        ...
                        <div class="product-image">
                            <img src="assets/images/products/home10/product3.png" alt="">
                        </div>
                    </a>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                    <a href="product-details.php" class="product-box product-box-medium product-box-medium3">
                        ...
                        <div class="product-image">
                            <img src="assets/images/products/home10/product4.png" alt="">
                        </div>
                    </a>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                    <a href="product-details.php" class="product-box product-box-medium product-box-medium3">
                        ...
                        <div class="product-image">
                            <img src="assets/images/products/home10/product5.png" alt="">
                        </div>
                    </a>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <a href="product-details.php" class="product-box product-box-medium product-box-medium4">
                        <div class="product-image product-image2">
                            <img src="assets/images/products/home10/man.png" alt="">
                        </div>
                        <div class="contents">
                            <span class="pretitle">-45% Offer</span>
                            <h1 class="product-title">SUMMER DEAL 2024</h1>
                ...
                <div class="section-header section-header3 section-header9 text-center">
                    <div class="wrapper">
                        <div class="sub-content">
                            <img class="line-1" src="assets/images/icons/icon-title.png" alt="">
                            <span class="sub-text">Collections</span>
                            <img class="line-2" src="assets/images/icons/icon-title.png" alt="">
                        </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="collection-item">
                                <div class="image">
                                    <a href="category.php"><img src="assets/images/products/home10/product6.png" alt="collection-image"></a>
                                    <div class="hot">NEW</div>
                                </div>
                                <div class="bottom-content">
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item">
                                <div class="image">
                                    <a href="category.php"><img src="assets/images/products/home10/product7.png" alt="collection-image"></a>
                                    <div class="hot">NEW</div>
                                </div>
                                <div class="bottom-content">
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item">
                                <div class="image">
                                    <a href="category.php"><img src="assets/images/products/home10/product8.png" alt="collection-image"></a>
                                    <div class="hot">NEW</div>
                                </div>
                                <div class="bottom-content">
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item">
                                <div class="image">
                                    <a href="category.php"><img src="assets/images/products/home10/product9.png" alt="collection-image"></a>
                                    <div class="hot">NEW</div>
                                </div>
                                <div class="bottom-content">
                            ...
                            <div class="row justify-content-lg-center">
                                <div class="col-xl-6 col-lg-4 col-md-4 col-sm-6 col-12 border-bottom p-0">
                                    <div class="wraper">
                                        <div class="image-section">
                                            <a href="product-details.php"><img src="assets/images/products/home10/product17.png" alt=""></a>
                                        </div>
                                        <div class="content">
                                            <div class="star-rating">
                                                <ul>
                                            ...
                                            <a href="product-details.php" class="product-title">Ray-Ban Sunglass</a>
                                ...
                                <div class="col-xl-6 col-lg-4 col-md-4 col-sm-6 col-12 border-bottom p-0">
                                    <div class="wraper border-0">
                                        <div class="image-section">
                                            <a href="product-details.php"><img src="assets/images/products/home10/product16.png" alt=""></a>
                                        </div>
                                ...
                                <div class="col-xl-6 col-lg-4 col-md-4 col-sm-6 col-12 border-bottom p-0">
                                    <div class="wraper">
                                        <div class="image-section">
                                            <a href="product-details.php"><img src="assets/images/products/home10/product6.png" alt=""></a>
                                        </div>
                                        <div class="content">
                                            <div class="star-rating">
                                                <ul>
                                            ...
                                            <a href="product-details.php" class="product-title"> Aviator Sunglass</a>
                                            <p class="product-price">$21.00</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-4 col-md-4 col-sm-6 col-12 border-bottom p-0">
                                    <div class="wraper border-0">
                                        <div class="image-section">
                                            <a href="product-details.php"><img src="assets/images/products/home10/product7.png" alt=""></a>
                                        </div>
                                        <div class="content last">
                                            <div class="star-rating">
                                                <ul>
                                            ...
                                            <a href="product-details.php" class="product-title">Stylish Men's Sunglass</a>
                                            <p class="product-price">$21.00</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-4 col-md-4 col-sm-6 col-12 p-0">
                                    <div class="wraper">
                                        <div class="image-section">
                                            <a href="product-details.php"><img src="assets/images/products/home10/product8.png" alt=""></a>
                                        </div>
                                        <div class="content">
                                            <div class="star-rating">
                                                <ul>
                                            ...
                                            <a href="product-details.php" class="product-title">Cartier Sunglass</a>
                                            <p class="product-price">$21.00</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-4 col-md-4 col-sm-6 col-12 p-0">
                                    <div class="wraper border-0">
                                        <div class="image-section">
                                            <a href="product-details.php"><img src="assets/images/products/home10/product9.png" alt=""></a>
                                        </div>
                                        <div class="content last">
                                            <div class="star-rating">
                                                <ul>
                                            ...
                                            <a href="product-details.php" class="product-title">Polycarbonate Sunglass</a>
                                            <p class="product-price">$21.00</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="collection-item">
                                            <div class="image">
                                                <a href="category.php"><img src="assets/images/products/home10/product16.png" alt="collection-image"></a>
                                                <div class="hot">NEW</div>
                                            </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="collection-item">
                                            <div class="image">
                                                <a href="category.php"><img src="assets/images/products/home10/product17.png" alt="collection-image"></a>
                                                <div class="hot">NEW</div>
                                            </div>
                                            <div class="bottom-content text-center">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-sm-6">
                        <div class="footer-widget">
                            <div class="footer-logo"><img src="assets/images/logo10-1.png" alt="footer-logo"></div>
                            ...
                            <div class="quick-contact">
                                <div class="phone contact-item">
                                    <div class="icon">
                                        <img src="assets/images/icons/bubble-chat2.svg" alt="icon">
                                    </div>
                                ...
                                <div class="email contact-item">
                                    <div class="icon">
                                        <img src="assets/images/icons/telephone-call2.svg" alt="icon">
                                    </div>
